...
function User() {
  ...
  useEffect(() => {
    ...
    const getUserData = async () => {
      ...
      // <<== FOLLOWING FOUR LINES MODIFIED DUE TO AXIOS ==>> //
          ...
          <div className="col-span-2">
            <div className="mb-6">
              <h1 className="text-3xl card-title">
                {name}
                <div className="ml-2 mr-1 badge bagdge-success">{type}</div>
        ...
        <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaUsers className="text-3xl md:tet-5xl" />
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaUserFriends className="text-3xl md:tet-5xl" />
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaCodepen className="text-3xl md:tet-5xl" />
            </div>
          ...
          <div className="stat">
            <div className="stat-figure text-secondary">
              <FaStore className="text-3xl md:tet-5xl" />
            </div>
